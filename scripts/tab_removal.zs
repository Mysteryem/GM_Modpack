...
mods.thaumcraft.Research.moveResearch("DAGGER", "FORBIDDEN", 1, 1);
mods.thaumcraft.Research.moveResearch("SLATE", "FORBIDDEN", 1, 0);
mods.thaumcraft.Research.moveResearch("RUNE", "FORBIDDEN", 3, -1);
mods.thaumcraft.Research.moveResearch("SACRIFICEDAGGER", "FORBIDDEN", 3, 1);
...
mods.thaumcraft.Research.setConcealed("SACRIFICEDAGGER", true);
